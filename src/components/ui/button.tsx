  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:translate-y-px",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground shadow-elevated hover:bg-primary/92",
        heroOutline:
          "border border-primary-foreground/25 bg-transparent text-primary-foreground hover:bg-primary-foreground/10",
        soft: "bg-secondary text-secondary-foreground shadow-soft hover:bg-secondary/70",
        panel:
          "bg-panel text-panel-foreground shadow-elevated hover:bg-panel/92",
